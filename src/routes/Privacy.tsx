      ...
      <React.Fragment>
        <div className="mantine-TypographyStylesProvider-root mantine-99m9wm">
          ...
          <p>
            ...
            recorded by Erasmus+ Website and how we use it.If you have
          ...
          <p>
            ...
            that appear on Erasmus+ Website, which are sent directly to users'
            ...
            content that you see on websites that you visit. Note that Erasmus+
          ...
          <p>
            ...
            Erasmus+ Website does not knowingly collect any Personal
          ...
          <p>
            ...
            that they shared and/or collect in Erasmus+ Website. This policy is
        ...
        <p>
          ...
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Erasmus+ Website and how we use it.If you have additional
          questions or require more information about our Privacy Policy, do not
          hesitate to contact us.
        </p>
        At Erasmus+ Website, accessible from https://msostream.live, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Erasmus+ Website and how we use it.If you have additional questions or
        ...
        <p>
          ...
          on Erasmus+ Website, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that Erasmus+ Website
        ...
        Erasmus+ Website, which are sent directly to users' browser. They
        automatically receive your IP address when this occurs. These
        ...
        <p>
          ...
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          Erasmus+ Website does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in Erasmus+ Website. This policy is not
        ...
        <div className="mantine-Container-root mantine-15pjuqq">
          ...
          <div className="mantine-TypographyStylesProvider-root mantine-99m9wm">
            <p>
              At Erasmus+ Website, accessible from https://msostream.live, one
              of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by Erasmus+ Website and how we use it.If
            ...
            <p>
              ...
              the advertising partners of Erasmus+ Website.Third-party ad
              ...
              and links that appear on Erasmus+ Website, which are sent directly
              ...
              Note that Erasmus+ Website has no access to or control over these
            ...
            <p>
              ...
              activity. Erasmus+ Website does not knowingly collect any Personal
              Identifiable Information from children under the age of 13. If you
              think that your child provided this kind of information on our
            ...
            <p>
              This Privacy Policy applies only to our online activities and is
              valid for visitors to our website with regards to the information
              that they shared and/or collect in Erasmus+ Website. This policy
